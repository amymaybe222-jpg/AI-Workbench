    ...
    <div>
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row">
        ...
        <input
          ...
          className="focus-ring w-full rounded-lg border border-border bg-surface px-4 py-3 text-sm text-text placeholder:text-text-muted/70 transition-colors focus:border-primary sm:text-base"
        />
        <button
          type="submit"
