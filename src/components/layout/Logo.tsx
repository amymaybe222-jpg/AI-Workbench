...
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-accent font-mono text-sm font-bold text-slate-950">
        {"</>"}
      </span>
