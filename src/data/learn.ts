...
export const learnTopics: LearnTopic[] = [
  // ---------- FOUNDATIONS ----------
  {
    ...
    summary:
      "The basics of generative AI, how it differs from traditional software, and why it matters at work.",
    readTime: "4 min",
  ...
  },
  {
    ...
    category: "Foundations",
    summary: "A practical, non-technical explanation of what an LLM is doing under the hood.",
    readTime: "5 min",
    tags: ["Basics", "Concepts"],
    sections: [
      {
  ...
  },
  {
    ...
    category: "Foundations",
    summary: "How to write clear, effective prompts that get you better results faster.",
    readTime: "6 min",
  ...
  },
  {
    ...
    category: "Foundations",
    summary: "Practical guardrails for data privacy, accuracy, and appropriate use in a professional setting.",
    readTime: "5 min",
  ...
  },
  {
    ...
    category: "Foundations",
    summary: "A simple framework for matching a task to the AI tool most likely to do it well.",
    readTime: "4 min",
    tags: ["Strategy", "Tools"],
    sections: [
      {
  ...
  // ---------- TOOLS ----------
  {
    ...
    category: "Tools",
    summary: "What Claude is, what it's best at, and how to get the most from it.",
    readTime: "4 min",
  ...
  },
  {
    ...
    category: "Tools",
    summary: "What ChatGPT is, what it's best at, and how to get the most from it.",
    readTime: "4 min",
    tags: ["ChatGPT", "OpenAI"],
  ...
  },
  {
    ...
    category: "Tools",
    summary: "How AI embedded in your notes and docs can save time on everyday knowledge work.",
    readTime: "3 min",
    tags: ["Notion", "Docs"],
  ...
  },
  {
    ...
    category: "Tools",
    summary: "How an in-editor AI pair programmer changes day-to-day engineering work.",
    readTime: "4 min",
  ...
  },
  {
    ...
    category: "Tools",
    summary: "Using an AI research tool that cites its sources.",
    readTime: "3 min",
  ...
  },
  {
    ...
    category: "Tools",
    summary: "Generating professional-quality visuals from text prompts.",
    readTime: "3 min",
